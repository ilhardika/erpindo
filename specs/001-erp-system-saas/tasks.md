...
- [ ] T007 [P] Apply database migration 001_initial_system_setup.sql (subscription_plans, companies, users tables)
- [ ] T008 [P] Apply database migration 002_business_entities.sql (customers, suppliers, employees, products tables)
- [ ] T009 [P] Apply database migration 003_sales_transactions.sql (sales_orders, invoices tables for MVP)
